...
<body>
    ...
    <section class="submenu">
        <div class="submenu-container">
            <div class="submenu-card">
                ...
                <a href="mobileOnly.php">Mobile</a>
            </div>
            <div class="submenu-card">
                <img
            ...
            <div class="submenu-card">
                <img
                    ...
                    alt="Broandband" />
                <a href="router.php">Broadband</a>
            </div>
        </div>
    </section>
    <!-- Products Section -->
    <section class="products" id="products">
        <h2 class="section-heading">Hot search</h2>
    ...
    <!-- New Release Section -->
    <section class="products" id="products">
        <h2 class="section-heading">New Release</h2>
        <div class="product-container">
            <button class="arrow-btn left-arrow disabled" data-target="productGridNewRelease">&#9664;</button>
            <div class="product-grid" id="productGridNewRelease">
                <?php if ($newReleases): ?>
                    <?php foreach ($newReleases as $device): ?>
                        <div class="product-card">
                            <div class="product-header">
                                <div class="product-category"><?= htmlspecialchars($device['category']); ?></div>
                                <div class="product-stock">Available: <?= htmlspecialchars($device['stock']) ?></div>
            ...
            <button class="arrow-btn right-arrow" data-target="productGridNewRelease">&#9654;</button>
        </div>
    </section>
