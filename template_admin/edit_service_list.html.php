                ...
                <tbody class="bg-white">
                    <?php foreach ($services as $service): ?>
                        <tr class="table-row">
                            ...
                            <td class="py-3 px-4 border-b border-gray-200 text-center">
                                <a href="../admin/edit_service.php?id=<?= htmlspecialchars($service['service_id'], ENT_QUOTES, 'UTF-8') ?>" class="btn-primary py-1 px-4 rounded-lg text-sm inline-block mb-2 shadow-md">
