...
<head>
    ...
    <style>
        ...
        .table-header {
            ...
            /* Cool Gray */
            color: white;
            font-size: 1.125rem; /* Increase font size for header */
        }
        ...
        .table-row td {
            font-size: 1.125rem; /* Increase font size for table content */
            padding: 1rem; /* Add padding to make cells larger */
        }

        /* Adjust font size for the table headers */
        .table-header th {
            font-size: 1.125rem; /* Increase font size for table headers */
            padding: 1rem; /* Add padding to make cells larger */
        }
    </style>
</head>
                ...
                <?php foreach ($accounts as $account): ?>
                    <tr class="table-row">
                        ...
                        <td class="border-b border-gray-200 text-center">
                            <!-- Check if the image exists and display it, otherwise use a default image -->
